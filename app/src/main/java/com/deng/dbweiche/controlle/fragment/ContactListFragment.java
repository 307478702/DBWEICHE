...
import com.deng.dbweiche.controlle.activity.AddContactActivity;
import com.deng.dbweiche.controlle.activity.ChatActivity;
import com.deng.dbweiche.controlle.activity.GroupListActivity;
import com.deng.dbweiche.controlle.activity.InviteActivity;
...
public class ContactListFragment extends EaseContactListFragment {
    ...
    private LinearLayout ll_contant_invite;
    ...
    protected void initView() {
        ...
        //添加头布局
        View headerView = View.inflate(getActivity(),R.layout.header_fragment_contant,null);
        ...
        //获取邀请信息条目的对象
        ll_contant_invite = headerView.findViewById(R.id.ll_contant_invite);
        ...
        //跳转到群组列表页面
        LinearLayout ll_contant_group = headerView.findViewById(R.id.ll_contant_group);
        ll_contant_group.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void setUpView() {
        ...
        ll_contant_invite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //红点处理
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.contect_delete){
            //执行删除联系人操作
            deleteContact();
