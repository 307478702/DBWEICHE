...
public class InviteTableDao {
    ...
    public void removeInvitation(String hxId){
        ...
        //执行删除语句
        db.delete(ContactTable.TAB_NAME,InviteTable.COL_USER_HXID+"=?",new String[]{hxId});
    ...
    public void updateInvitationStatus(InvationInfo.InvitationStatus invitationStatus,String hxId){
        ...
        value.put(InviteTable.COL_STATUS,invitationStatus.ordinal());
        db.update(InviteTable.TAB_NAME,value,InviteTable.COL_USER_HXID + "=?",new String[]{hxId});
    }
}
